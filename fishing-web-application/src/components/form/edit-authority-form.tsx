...
export const EditAuthorityForm = ({data}:EditAuthorityFormProps) => {
  ...
  const [formState, action] = useFormState(actions.modifyAuthority, {
    errors: {},
  });
    ...
    <>
      <form action={action} className="space-y-3 w-full pt-3">
        ...
        <Input
          ...
          />
          <Input
            defaultValue={data.fisheryAuthorityName}
            name="authorityName"
          ...
          />
          <Autocomplete
            defaultInputValue={data.waterArea.waterAreaName}
            name="waterAreaName"
            label="Water area"
            type="text"
            variant="bordered"
          ...
          />
           <Autocomplete
           defaultInputValue={data.address.city.cityName}
            name="cityName"
            label="City"
            type="text"
            variant="bordered"
          ...
          />
          <Input
            defaultValue={String(data.address.streetNumber)}
            name="streetNumber"
            label="Street number"
            type="number"
            variant="bordered"
          ...
          />
          <Input
            defaultValue={data.address.floor !== null ? String(data.address.floor) : undefined}
            name="floor"
          ...
          />
          <Input
            defaultValue={data.address.door !== null ? String(data.address.door) : undefined}
            name="door"
