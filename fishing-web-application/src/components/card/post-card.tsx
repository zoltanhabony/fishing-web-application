...
export const PostCard = ({
  ...
  return (
    <div className="flex gap-4 items-start flex-col border-solid border-1 border-default p-5 rounded-xl">
      ...
      <div className="flex gap-3">
        ...
        {isAuthor ? (
          <div className="flex ">
            <Button variant="light" isIconOnly size="lg" color="primary" aria-label="Like" onClick={()=>router.push(`/post/${postId}/edit`)}>
              <EditIcon />
            </Button>
      ...
      <Button variant="light" size="md" color="primary" aria-label="Like" onClick={()=>router.push(`/post/${postId}`)}>
      View post
      </Button>
              ...
              <ModalContent>
                {(onClose) => (
                  <>
                    ...
                    <ModalBody>
                      <p>{"The operation is final and cannot be revoked! Deleting the post will remove all data."}</p>
                      <br />
